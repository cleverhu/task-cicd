...
import (
	...
	versioned "github.com/cleverhu/task-cicd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/cleverhu/task-cicd/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/cleverhu/task-cicd/pkg/client/listers/task/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CicdV1alpha1().Tasks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CicdV1alpha1().Tasks(namespace).Watch(context.TODO(), options)
			},
		},
		&taskv1alpha1.Task{},
		resyncPeriod,
