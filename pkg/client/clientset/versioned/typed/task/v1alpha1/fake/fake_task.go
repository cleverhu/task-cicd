...
type FakeTasks struct {
	Fake *FakeCicdV1alpha1
	ns   string
}

var tasksResource = schema.GroupVersionResource{Group: "cicd.study-k8s.com", Version: "v1alpha1", Resource: "tasks"}

var tasksKind = schema.GroupVersionKind{Group: "cicd.study-k8s.com", Version: "v1alpha1", Kind: "Task"}
